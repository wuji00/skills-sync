...
| type                   | Optional\[Union\[[SearchType](#searchtype), str]]                       | Search type - 'auto' (default), 'fast', 'deep', 'deep-reasoning', or 'instant'.                                                                                                                                                                                                                       | None     |
...
| additional\_queries    | Optional\[List\[str]]                                                   | Alternative query formulations for deep search to skip automatic LLM-based query expansion. Max 5 queries. Only applicable when type is 'deep' or 'deep-reasoning'. Example: \["machine learning", "ML algorithms", "neural networks"]                                                                | None     |
| output\_schema         | Optional\[Dict\[str, Any]]                                              | JSON schema for deep search structured output. When provided, `response.output.content` follows this schema. Only applicable when type is 'deep' or 'deep-reasoning'.                                                                                                                                 | None     |
...
| num\_sentences       | int  | Deprecated and will be removed in a future release. Currently mapped to a character budget (1 sentence ≈ 1333 characters). Use max\_characters instead. |
| highlights\_per\_url | int  | Deprecated and will be removed in a future release. Currently ignored. Use max\_characters instead.                                                     |
...
| Field     | Type                                                           | Description                                                                               |
| --------- | -------------------------------------------------------------- | ----------------------------------------------------------------------------------------- |
| content   | Union\[str, dict\[str, Any]]                                   | Deep-search synthesized content (string by default, object when `output_schema` is used). |
...
**Type:** Literal\['auto', 'fast', 'deep', 'deep-reasoning', 'instant']
